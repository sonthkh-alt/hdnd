import { LayoutDashboard, Users, CheckSquare, Calendar, Bot, Building2, LogOut, UserCircle } from 'lucide-react';
import { cn } from '../lib/utils';
import { useApp } from '../store';

export type TabId = 'dashboard' | 'departments' | 'employees' | 'tasks' | 'schedules' | 'assistant' | 'approvals';
